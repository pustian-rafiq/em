...
function createData(no, name, icon) {
    return { no, name, icon };
}

const rows = [
    createData(1, 'Arts, Crafts and Collectibles', 'Arts, Crafts and Collectibles logo'),
    createData(2, 'Arts, Crafts and Collectibles', 'Arts, Crafts and Collectibles logo'),
    createData(3, 'Arts, Crafts and Collectibles', 'Arts, Crafts and Collectibles logo'),
    createData(4, 'Arts, Crafts and Collectibles', 'Arts, Crafts and Collectibles logo'),
    createData(5, 'Arts, Crafts and Collectibles', 'Arts, Crafts and Collectibles logo'),
    createData(6, 'Arts, Crafts and Collectibles', 'Arts, Crafts and Collectibles logo'),
        ...
        .map((row, index) => {
            ...
            return (
                ...
                >
                    ...
                    <TableCell className="tableBorder" align="left">{row.icon}</TableCell>
                    <TableCell className="tableBorder" align="left">
                        <Link href={`/admin-dashboard/inventory/edit-category/${row.no}/`} passHref>
                            <Typography
                            variant='span' component='span' sx={{ background: '#4F5ECE', fontSize: '20px', padding: '3px', color: '#fff' }}>
