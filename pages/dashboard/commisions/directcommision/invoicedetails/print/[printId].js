...
// Upper table section
function createData(sl, cin, salesprice, commision, salespriceusd, commisionusd) {
    return {
          sl, 
          cin,
          salesprice,
...
const rows = [
    createData(1, 1111250,50.00,5.91,0.25,0.07),
    createData(2, 1111251,60.00,6.62,0.27,0.06),
    createData(3, 1111252,70.00,7.42,0.58,0.03),
        ...
        .map((row, index) => {
            ...
            return (
                ...
                >
                    ...
                    <TableCell className="tableBorder" align="left">{row. sl}</TableCell>
                ...
                <Box sx={{ width: '100%' }} style={{ paddingRight: '5px' }} >
                    ...
                    <Box>
                        ...
                        <Grid container spacing={2} sx={{my:'20px'}}>
                            ...
                            <strong>Sender Consumer Phone No</strong>	: 8801711571561 <br/>
                            ...
                            <Grid item xs={4} md={4} lg={4}>
                                ...
                                <strong>Payment Total USD </strong>: 0.069<br/>
                                <strong>Transaction Id</strong>: 9BM40NLYRY<br/>
                                <strong>Payment Process </strong>: bKash<br/>
...
PrintDetails.getLayout = function pageLayout(page) {
