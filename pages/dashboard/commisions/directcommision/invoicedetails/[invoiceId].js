    ...
    return (
        <TableHead  >
            <TableRow>
                ...
                > Total Amt for Payment</TableCell>
                <TableCell
                    align="left"
                    style={{ paddingLeft: '10px', background: 'rgb(247, 247, 247)', background: 'rgb(235, 235, 235)' }}
                    className="tableBorder"
                >Total Amt USD</TableCell>
                <TableCell
                    align="left"
                    style={{ paddingLeft: '10px', background: 'rgb(247, 247, 247)', background: 'rgb(235, 235, 235)' }}
                    className="tableBorder"
        ...
        <TableHead  >
            <TableRow>
                ...
                <TableCell
                    ...
                    style={{ paddingLeft: '10px', background: 'rgb(247, 247, 247)', background: 'rgb(235, 235, 235)' }}
                    className="tableBorder"
                > Receiver's CIN</TableCell>
                <TableCell
                    align="left"
                    style={{ paddingLeft: '10px', background: 'rgb(247, 247, 247)', background: 'rgb(235, 235, 235)' }}
                    className="tableBorder"
                > Sales Price</TableCell>
                <TableCell
                    align="left"
                    style={{ paddingLeft: '10px', background: 'rgb(247, 247, 247)', background: 'rgb(235, 235, 235)' }}
                    className="tableBorder"
                ...
                <TableCell
                    ...
                    style={{ paddingLeft: '10px', background: 'rgb(247, 247, 247)', background: 'rgb(235, 235, 235)' }}
                    className="tableBorder"
                >Sales Price in USD($)	</TableCell>
                <TableCell
                    align="left"
                    style={{ paddingLeft: '10px', background: 'rgb(247, 247, 247)', background: 'rgb(235, 235, 235)' }}
                    className="tableBorder"
                >Commission in USD($)</TableCell>
...
const InvoiceDetails = () => {
    ...
    const bkashPaymentData = rows.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage)
        .map((row, index) => {
            ...
            return (
                ...
                >
                    <TableCell className="tableBorder" align="left">{row.totalpayamt}</TableCell>
                    <TableCell className="tableBorder" align="left">{row.totalamtusd}</TableCell>
                    <TableCell className="tableBorder" align="left">{row.trxid}</TableCell>
                </TableRow>
            );
        })
    //Show bank data and searches real time
    const paymentData = paymentRows.slice(page * rowsPerPage, page * rowsPerPage + rowsPerPage)
        .map((row, index) => {
            ...
            return (
                ...
                >
                    ...
                    <TableCell className="tableBorder" align="left">{row.commisionusd}</TableCell>
                </TableRow>
            );
        })
        ...
        <>
            <div className={styles.paymentTopSection}>
                <Box sx={{ width: '100%' }} style={{ paddingRight: '5px' }} >
                    <Paper sx={{ width: '100%', mb: 2, mt: 3 }} style={{ paddingRight: '15px', paddingLeft: '15px', marginTop: '20px' }} >
                    <div style={{ marginTop: '10px' }} className={styles.topSection} > </div>
                        <div style={{ marginTop: '10px' }} className={styles.invoiceBorder}>
                            <Link href={`../../../../dashboard/commisions/directcommision/invoicedetails/print/${invoiceId}`}>
                                <Button className={styles.printButton}>
                                    Print Commision
                                </Button>
                            </Link>
                            <div className={styles.title}>Successfully Paid Direct Commission</div>
                        </div>
...
InvoiceDetails.getLayout = function pageLayout(page) {
