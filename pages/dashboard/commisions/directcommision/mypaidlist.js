...
const rows = [
  createData(1, 'Sept. 15, 2021, 12:34 p.m.', ['151'], 3.7, 67, 'we3445565rfgf',),
  createData(2, 'Sept. 15, 2021, 12:34 p.m.', ['151'], 25.0, 51, 'we3445565rfgf'),
  createData(3, 'Sept. 15, 2021, 12:34 p.m.', ['151'], 16.0, 24, 'we3445565rfgf'),
  createData(4, 'Sept. 15, 2021, 12:34 p.m.', ['151'], 6.0, 24, 'we3445565rfgf'),
];
    ...
    .map((row, index) => {
      ...
      return (
        ...
        >
          ...
          <TableCell className="tableBorder" align="left">{row.createdate}</TableCell>
          <TableCell className="tableBorder" align="left">{row.commisionid}</TableCell>
          <TableCell className="tableBorder" align="left">{row.totalamt}</TableCell>
          ...
          <TableCell className="tableBorder " align="left">
            <Link href={`../../../../dashboard/commisions/directcommision/invoicedetails/${row.sl}/`}>
              <span title='Click for details information' className={styles.linkButton}> <VisibilityIcon /></span>
            </Link>
            <Link href={`../../../../dashboard/commisions/directcommision/invoicedetails/${row.sl}/`}>
              <span title='Click for print' className={styles.linkButton}> <PrintIcon /></span>
            </Link>
...
export default MyPaidList;

MyPaidList.getLayout = function pageLayout(page) {
