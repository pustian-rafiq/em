...
function createData(sl, cin, salesprice, commision, salespriceusd, commisionusd, trxid, details) {
  return {
    sl,
    cin,
    salesprice,
...
const rows = [
  createData(1, '1111250', 50, 5.910, 0.5800, 67, 'we3445565rfgf', 'Details'),
  createData(2, '1111251', 50, 5.910, 0.5800, 51, 'we3445565rfgf', 'Details'),
  createData(3, '1111252', 50, 5.910, 0.5800, 24, 'we3445565rfgf', 'Details'),
  createData(4, '1111253', 50, 5.910, 0.5800, 24, 'we3445565rfgf', 'Details'),
];
    ...
    <TableHead  >
      <TableRow>
        ...
        <TableCell
          ...
          style={{ paddingLeft: '10px', background: 'rgb(247, 247, 247)', background: 'rgb(235, 235, 235)' }}
          className="tableBorder"
        >Receiver Consumer CIN</TableCell>
        <TableCell
          align="left"
          style={{ paddingLeft: '10px', background: 'rgb(247, 247, 247)', background: 'rgb(235, 235, 235)' }}
          className="tableBorder"
    ...
    .map((row, index) => {
      ...
      return (
        ...
        >
          ...
          <TableCell className="tableBorder" align="left">{row.trx}</TableCell>
          <TableCell className="tableBorder " align="left"> {row.details}</TableCell>
        </TableRow>
      );
    })
