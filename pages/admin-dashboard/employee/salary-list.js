...
function createData(no,employee,phone, month,grosssalary,receiveamt,remaingamt,paynow) {
  return {
    no,employee,phone, month,grosssalary,receiveamt,remaingamt,paynow
  };
}

const rows = [
  createData(1, 'Nazmul1','0171157156','January','10000', '25000','30000','40000'),
  createData(2, 'Nazmul2','0171157156','January','20000', '25000','30000','40000'),
  createData(3, 'Nazmul3','01711571551','January','30000', '25000','30000','40000'),
  createData(4, 'Nazmul4','017115715551','January','30000', '25000','30000','40000'),
  createData(5, 'Nazmul5','017115715666','January','40000', '25000','30000','40000'),
    ...
    .map((row, index) => {
      ...
      return (
        ...
        >
          ...
          <TableCell className="tableBorder" align="left">{row.paynow}</TableCell>
          <TableCell className="tableBorder " align="left"  >
...
SalarySheet.getLayout = function pageLayout(page) {
