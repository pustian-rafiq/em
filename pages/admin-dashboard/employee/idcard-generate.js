...
function createData(no, photo, employee, designation, email, contact) {
  return {
    no, photo, employee, designation, email, contact
  };
}
const rows = [
  createData(1, 'photo', 'Md. Golam  Mim', 'React Developer', 'mim.cse32@gmail.com', '018988789er'),
  createData(2, 'photo', 'Md. Hakkani Mim', 'React Developer', 'mim.cse32@gmail.com', '018988789er'),
  createData(3, 'photo', 'Md.Mim', 'React Developer', 'mim.cse32@gmail.com', '018988789er'),
  createData(4, 'photo', 'Md. Rafiqul Islam', 'React Developer', 'mim.cse32@gmail.com', '018988789er'),
];
  ...
  return (
    <TableHead>
      <TableRow>
        ...
        <TableCell className="tableBorder headbackground" padding="checkbox" style={{ width: '10%',paddingLeft: '15px' }}>
          Select All  <Checkbox
            color="primary"
    ...
    .map((row, index) => {
      ...
      return (
        ...
        >
          ...
          <TableCell className="tableBorder" align="left">{row.photo}</TableCell>
          ...
          <TableCell className="tableBorder" align="left">{row.contact}</TableCell>
      ...
      <Box sx={{ width: '100%' }} style={{ paddingRight: '5px' }} >
        <Paper sx={{ width: '100%', mb: 2, mt: 3,pb:3 }} style={{ paddingRight: '15px', paddingLeft: '15px' }}>
          ...
          <Grid container spacing={2} rowSpacing={4}>
            <Grid item md={6}>
              <Autocomplete
                ...
                renderInput={(params) => (
                  <TextField {...params} label="Select Companies*" placeholder="Search by company" />
                )}
              />
            </Grid>
            <Grid item md={6}>
          ...
          />
            ...
            <Button   sx={{background:'#c12f2a', color:'#fff', textTransform:'capitalize',
            ":hover":{
              background:'#fb160a'
            }
