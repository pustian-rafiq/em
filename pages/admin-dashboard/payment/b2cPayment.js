...
const headCells = [
  ...
  },
  {
    ...
    numeric: false,
    disablePadding: false,
    label: 'Requisition amt (local currency)',
  },
  {
    id: 'tax',
    numeric: false,
    ...
    .map((row, index) => {
      ...
      return (
        ...
        >
          ...
          <TableCell className="tableBorder" align="left">{row.requisition}</TableCell>
          <TableCell className="tableBorder" align="left">{row.requisition_amt}</TableCell>
          <TableCell className="tableBorder" align="left">{row.tax}</TableCell>
...
b2cPayment.getLayout = function pageLayout(page) {
