    ...
    .map((row, index) => {
      ...
      return (
        ...
        >
          ...
          <TableCell className="tableBorder" align="left">{row.vendor}</TableCell>
          <TableCell className="tableBorder" align="left">{row.ordered_by}</TableCell>
...
SelectTax.getLayout = function pageLayout(page) {
