...
function createData(sl, sector, percentage, country, state, county, city) {
  return {
    sl, sector, percentage, country, state, county, city
  };
}

const rows = [
  createData(1, 'Various basic goods1', '14.0', 'Algeria', 'None', 'None', 'None'),
  createData(2, 'Various basic goods1', '14.0', 'Algeria', 'None', 'None', 'None'),
  createData(3, 'Various basic goods1', '14.0', 'Algeria', 'None', 'None', 'None'),
  createData(4, 'Various basic goods1', '14.0', 'Algeria', 'None', 'None', 'None'),
  createData(5, 'Various basic goods1', '14.0', 'Algeria', 'None', 'None', 'None'),
...
export default UnpaidVatList;

UnpaidVatList.getLayout = function pageLayout(page) {
