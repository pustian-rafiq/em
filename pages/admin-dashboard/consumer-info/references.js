    ...
    .map((row, index) => {
      ...
      return (
        ...
        >
          ...
          <TableCell className="tableBorder" align="left"   sx={{fontSize:{xs:'12px',md:'15px'} }}>{row.sl}</TableCell>
          ...
          <TableCell className="tableBorder" align="left"   sx={{fontSize:{xs:'12px',md:'15px'} }}>{row.ref1}</TableCell>
          <TableCell className="tableBorder" align="left"   sx={{fontSize:{xs:'12px',md:'15px'} }}>{row.ref2}</TableCell>
          <TableCell className="tableBorder" align="left"   sx={{fontSize:{xs:'12px',md:'15px'} }}>{row.totalref}</TableCell>
          <TableCell className="tableBorder" align="left"   sx={{fontSize:{xs:'12px',md:'15px'} }}>{row.refered_by}</TableCell>
          <TableCell className="tableBorder" align="left"   sx={{fontSize:{xs:'12px',md:'15px'},width:'21%' }}>
            <Link href={`/admin-dashboard/consumer-info/leftreferenceDetails/${row.sl}/`} passHref>
              <Button sx={{margin:'2px 2px 0px 0px',color:'#fff',background:'#4F5ECE',textTransform:'capitalize',fontSize:{xs:'12px',sm:'15px'},":hover":{background:'#15258e'},padding:'1px 0px'}}>
              Ref-1
              </Button>
              
            </Link>
            <Link href={`/admin-dashboard/consumer-info/aboverootDetails/${row.sl}/`} passHref>
              <Button sx={{margin:'2px 2px 0px 0px',color:'#fff',background:'#0DA8EE',textTransform:'capitalize',fontSize:{xs:'12px',sm:'15px'},":hover":{background:'#1799d1'},padding:'1px 0px'}}>
              Root
              </Button>
            </Link>
            <Link href={`/admin-dashboard/consumer-info/rightreferenceDetails/${row.sl}/`} passHref>
              <Button sx={{margin:'2px 2px 0px 0px',color:'#fff',background:'#4F5ECE',textTransform:'capitalize',fontSize:{xs:'12px',sm:'15px'},":hover":{background:'#15258e'},padding:'1px 0px'}}>
              Ref-2
              </Button>
            </Link>
...
Reference.getLayout = function pageLayout(page) {
