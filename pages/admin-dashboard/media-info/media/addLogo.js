        ...
        .map((row, index) => {
            ...
            return (
                ...
                >
                    ...
                    <TableCell className="tableBorder" align="left">{row.logo}</TableCell>
                    <TableCell className="tableBorder " align="left" style={{ width: '15%' }}>
                        <Link href={`/admin-dashboard/employee/designation-update/${row.sl}/`} passHref>
                            <Typography
                                variant='span' component='span' sx={{ background: '#0DA8EE', borderRadius: '3px', fontSize: '15px', mr: 1, padding: '5px 1px', color: '#fff' }}>
                ...
                <Paper sx={{ width: '100%', mb: 2, mt: 3 }} style={{ paddingRight: '15px', paddingLeft: '15px' }} >
                    <Grid container>
                        <Grid item sm={12} md={8}>
                            <Typography variant="h4" component="div" sx={{ display: 'flex', pt: 2 }}>
                                <CopyToClipboard onCopy={onCopyText} text={data}>
                                    <Button sx={{ background: '#BFC6CD', marginRight: '3px' }} variant='contained'>Copy</Button>
                                </CopyToClipboard>

                                <Button sx={{ background: '#2AB9D0', marginRight: '3px' }} variant='contained'> <CSVLink {...csvReport}>CSV</CSVLink> </Button>
                                {/* <Button onClick={(e) => exportToCSV(rows, 'fileName')} sx={{ background: '#2AB9D0', marginRight: '3px' }} variant='contained'>CSV</Button> */}
                                <Button onClick={(e) => exportToCSV(rows, 'EhsanMarketting')} sx={{ background: '#59BF70', marginRight: '3px' }} variant='contained'>Excel</Button>
                                <Button onClick={printDocument} sx={{ background: '#E91E63', marginRight: '3px' }} variant='contained'>PDF</Button>
                    ...
                    <TableContainer id="pdfdiv" style={{ marginTop: '0px', background: 'white' }} >
                        <Table
                            sx={{
...
AddLogo.getLayout = function pageLayout(page) {
