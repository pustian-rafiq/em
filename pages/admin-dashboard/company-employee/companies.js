...
function createData(sl, name, code, email, mobile, websitelink) {
  return {
    sl,
    name,
    code,
...
const rows = [
  createData(1, 'Ehsan Marketing1', 'EM-00001', 'infoehsanmarketing@gmail.com', '01769921000', 'https://ehsanmarketing.com/'),
  createData(2, 'Ehsan Marketing2', 'EM-00002', 'infoehsanmarketing@gmail.com', '01769921000', 'https://ehsanmarketing.com/'),
  createData(3, 'Ehsan Marketing3', 'EM-00003', 'infoehsanmarketing@gmail.com', '01769921000', 'https://ehsanmarketing.com/'),
  createData(4, 'Ehsan Marketing4', 'EM-00004', 'infoehsanmarketing@gmail.com', '01769921000', 'https://ehsanmarketing.com/'),
...
const Companies = () => {
  ...
  const tableDatas = rows.filter((search) => {
    return (
      ...
      search.mobile.toLowerCase().includes(searchText.toLowerCase())
    );
  });
    ...
    .map((row, index) => {
      ...
      return (
        ...
        >
          ...
          <TableCell className="tableBorder" align="left">{row.mobile}</TableCell>
          <TableCell className="tableBorder" align="left">{row.websitelink}</TableCell>
          <TableCell className="tableBorder " align="left" style={{ width: '5%' }}>
            <Link href={`/admin-dashboard/company-employee/company-details/${row.sl}/`} passHref>
      ...
      <Box sx={{ width: '100%' }} style={{ paddingRight: '5px' }} >
        <Paper sx={{ width: '100%', mb: 2, mt: 3 }} style={{ paddingRight: '15px', paddingLeft: '15px' }} >
          <Typography variant="h4" component="div" sx={{
            ...
            <Add />
            <Link href="/admin-dashboard/company-employee/create-company/">
              Add Company
            </Link>
          </Typography>
...
Companies.getLayout = function pageLayout(page) {
