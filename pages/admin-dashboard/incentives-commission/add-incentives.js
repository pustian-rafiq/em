                                ...
                                <Item style={{ padding: '20px 20px' }}>
                                    <Grid container spacing={3}>
                                        ...
                                        <Grid item xs={12} md={2} className={styles.rowSpace}>
                                            ...
                                            <div style={{ border: '1px solid #000', height: '80px', width: '80px', marginBottom: '10px' }}>
                                                {imagePreview.file ?
                                                    <Image src={imagePreview.file} width="80" height="80" />
                                                    :
                                                    <Image src="/images/profile-picture.jpg" width="80" height="80" />
                                                }
...
AddIncentives.getLayout = function pageLayout(page) {
