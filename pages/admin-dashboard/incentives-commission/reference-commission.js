    ...
    .map((row, index) => {
      ...
      return (
        <TableRow
          ...
          className="rowHover"
        >
          <TableCell sx={{fontSize:{md:'15px',sm:'10px',xs:'10px'}}} className="tableBorder">{row.sl}</TableCell>
          <TableCell sx={{fontSize:{md:'15px',sm:'10px',xs:'10px'}}} className="tableBorder" align="left">{row.username}</TableCell>
          <TableCell sx={{fontSize:{md:'15px',sm:'10px',xs:'10px'}}} className="tableBorder" align="left">{row.fullname}</TableCell>
          <TableCell sx={{fontSize:{md:'15px',sm:'10px',xs:'10px'}}} className="tableBorder" align="left">{row.amount}</TableCell>
          <TableCell sx={{fontSize:{md:'15px',sm:'10px',xs:'10px'}}} className="tableBorder" align="left">{row.date_time}</TableCell>
        </TableRow>
      );
    })
  return (
...
export default ReferenceCommission;

ReferenceCommission.getLayout = function pageLayout(page) {
